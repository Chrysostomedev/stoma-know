...
const formSteps = [
  { id: "info", label: "Informations", description: "Titre et description du sondage" },
  { id: "questions", label: "Questions", description: "Construisez votre formulaire" },
  { id: "design", label: "Design", description: "Personnalisez l'apparence" },
  { id: "review", label: "Aperçu", description: "Vérifiez tout avant publication" },
];
...
export const SurveyFormBuilder: React.FC<SurveyFormBuilderProps> = ({
  ...
  const handlePublish = () => {
    onPublish?.({ title, description, questions });
  };
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Contenu de l'étape */}
      <Card padding="lg" className="min-h-[500px] overflow-hidden">
